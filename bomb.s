...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp 
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx // local variable
  40133f:	48 89 f5             	mov    %rsi,%rbp // local viarbale
  401342:	e8 d4 ff ff ff       	callq  40131b // string _length(source)
  <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d 
  40134a:	48 89 ef             	mov    %rbp,%rdi
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length> // string_lenght(target)
  401352:	ba 01 00 00 00       	mov    $0x1,%edx
  401357:	41 39 c4             	cmp    %eax,%r12d // 两个string的长度是否相等
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>
  40135c:	0f b6 03             	movzbl (%rbx),%eax // result = target;
  40135f:	84 c0                	test   %al,%al // result的最后两位不是0
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp //24 bytes buffer
  401460:	48 89 f2             	mov    %rsi,%rdx // before calling the function , rsp's value
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx // 4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax // 20
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) // 
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax // 
  401474:	48 89 04 24          	mov    %rax,(%rsp)
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9: r9
